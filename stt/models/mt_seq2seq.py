...
@Model.register("mt_seq2seq")
class MTSeq2Seq(Model):
    """
    This ``MTSeq2Seq`` class is a :class:`Model` which takes a sequence, encodes it, and then
    ...
    def __init__(self,
        ...
        super(MTSeq2Seq, self).__init__(vocab)
        ...
        if splits is not None:
            self.crit = AdaptiveLogSoftmaxWithLoss(
                target_embedding_dim, num_classes, splits)
